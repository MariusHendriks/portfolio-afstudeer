          ...
          <FadeIn>
            ...
            <div>
              <div ref={Aanleiding}>
                ...
                <p>
                  Doordat ik een user test heb uitgevoerd voor Mike Hendriks
                  kwam ik erachter dat ook hij een form-builder aan het maken
                  is. Het leek mij relevant om onze onderzoeksresultaten te
                  vergelijken met elkaar. Om deze reden hebben we voor elkaar
                  een co-reflection uitgevoerd.
                </p>
              </div>
              <div ref={Uitvoering}>
                <h2>Uitvoering</h2>
                <p>
                  Mike en ik hebben beide een informele presentatie gegeven aan
                  elkaar over het onderzoek dat we hebben uitgevoerd en wat de
                  resultaten hiervan waren. Mike had een volledig ander product
                  met dezelfde essentie: formulieren bouwen. Zijn taak is
                  namelijk een form-builder plugin te maken voor het
