          ...
          <FadeIn>
            ...
            <div>
              <div ref={Aanleiding}>
                ...
                <p>
                  Er is een Expert interview uitgevoerd omdat het relevant is om
                  te weten welke componenten- volgens de expert- het hardst
                  nodig zijn om data platform completer te maken.
                </p>
                <p>
                  ...
                  heeft hij veel kennis over hoe het programma in elkaar steekt.
                </p>
                <p>
              ...
              <div ref={Uitvoering}>
                <h2>Uitvoering</h2>
                <p>
                  Frederik Venneman is op 03-04-2021 geïnterviewd. Om alle
                  gestelde vragen en de antwoorden te bekijken, navigeer dan
                  naar het "Gehele Onderzoek" tabje in het menu.
                </p>
                <p>
                  <YouTube videoId={"kwCizRjU9Ew"} opts={opts} />
                </p>
              </div>
              <div ref={Conclusie}>
                <p>
                ...
                <p>
                  ...
                  />{" "}
                  onderzoek de meeste werkdruk veroorzaken volgens Frederik
                  Vennemann, <Tooltip woord="hoofdgebruiker" /> van Data panel.
                </p>
                <p>
                  Frederik geeft aan dat het onduidelijk is welke data er
                  beschikbaar is (1:28), hoe die data er uit ziet en vind het
                  frustrerend dat hij steeds in de modellen moet kijken wat de
                  exacte naam is van de data die hij wil gebruiken (5:15). Dit
                  neemt veel tijd in omdat er steeds heen en weer genavigeerd
                ...
                <p>
                  De tabs zijn ook een vervelend onderdeel om te configureren
                  geeft Frederik aan.
                </p>
              </div>
