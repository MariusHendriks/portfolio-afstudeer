                  ...
                  <FadeIn>
                      ...
                      <div>
                          <div ref={Aanleiding}>
                              ...
                              <p>
                                  Omdat er geen overzicht was van welke
                                  configuraties (
                                  ...
                                  wordt wat voor categorieën er op data panel
                                  zijn. Hier kan in latere onderzoeken op
                                  gecategoriseerd worden om per categorie de
                                  werkdruk te bepalen.
                              </p>
                          </div>
                          <div ref={Uitvoering}>
                              ...
                              <p>
                                  ...
                                  configuraties en is er bestudeert welke{" "}
                                  <Tooltip woord="componenten" /> deze
                                  configuraties weergeven. In [Figuur 1:
                                  voorbeeld configuratie] is een van deze
                                  configuraties te zien. Deze configuratie zorgt
                                  ervoor dat [Figuur 2: resultaat] configuratie
                                  weergegeven wordt. Voor dit voorbeeld is de
                                  categorie "Tabel" gebruikt. Met deze{" "}
                                  <Tooltip woord="JSON" /> wordt de tabel van
                                  [Figuur 2: Resultaat configuratie]
                              </p>
                                  ...
                                  <div className="s-page__content__img__container__img">
                                      ...
                                      <Zoom>
                                          <img
                                              ...
                                              src={
                                                  VoorbeeldConfiguratieResultaat
                                              }
                                          />
                                      </Zoom>
                                  </div>
                          ...
                          <div ref={Conclusie}>
                              ...
                              <p>
                                  Doordat dit onderzoek is uitgevoerd is er een
                                  overzicht welke configuraties welke{" "}
                                  <Tooltip woord="componenten" /> weergeven.
                                  Deze configuraties zijn opgedeeld in
                                  categorieën, waar alle tabel-gerelateerde
                                  configuraties onder de categorie 'tabel' zijn
                                  gezet. Doordat dit inzichtelijk is gemaakt
                                  kunnen deze categorieën in latere fases van
                                  het project gebruikt worden.
                              </p>
                              <p>
                                  Dit zijn de categorieën die uit dit onderzoek
                                  zijn gekomen:{" "}
                              </p>
                              <ul>
                                  <li>Tabel</li>
                                  <li>
                                      Formulier (om rijen toe te voegen aan
                                      tabellen)
                                  </li>
                                  ...
                                  <li>
                                      Acties (rows toe kunnen voegen aan kolom)
                                  </li>
                              ...
                              <p>
                                  ...
                                  <InlineLink
                                      ...
                                      newTab={false}
                                  />{" "}
                                  om te bepalen waar de meeste werkdruk
                                  ontstaat.
                              </p>
                          </div>
