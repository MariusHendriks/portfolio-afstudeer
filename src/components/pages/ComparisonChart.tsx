          ...
          <FadeIn>
            ...
            <div>
              ...
              <div ref={Uitvoering}>
                <h2>Uitvoering</h2>
                <p>
                  In dit onderzoek is er gekeken naar de mogelijkheden die er zijn om het formulier component. Na een brainstormsessie met twee collega's zijn de mogelijkheden vastgesteld. De mogelijkheden zijn:
                </p>
                <ul>
                  <li>
                    <b>JSON configuraties</b> (huidige situatie). Op de huidige manier kunnen formulieren gemaakt worden. Echter is hier hoge technische kennis voor nodig en is niet toegankelijk genoeg voor de wensen
                  </li>
                  <li>
                    <b>Genereren</b>. Omdat het al duidelijk is welke velden er ingevuld moeten worden, zou het mogelijk moeten zijn de formulieren tot op zekere hoogte te genereren. Deze oplossing is echter ontzettend gelimiteerd.
                  </li>
                  <li>
                    <b>Form-builder</b>. Een andere oplossing is een form-builder. In een form builder kan een formulier eenvoudig in elkaar geklikt worden.
                  </li>
                  <li>
                    <b>Outsourcing</b>. Er zijn platformen die de oplossing klaar hebben liggen. Dit zal nooit gratis zijn en is wellicht niet flexibel genoeg voor de specifieke eissen die data panel met zich meebrengt.
                  </li>
                </ul>
                <p>
                ...
                <p>
                  Data panel heeft op dit moment al veel mogelijkheden om formulieren goed aan te laten sluiten bij de behoefte. Zo kunnen er bijvoorbeeld selectievelden worden weergegeven in plaats van een tekstveld om eentonigere- en vooraf gedefinieerde resultaten te krijgen. Dit maakt bijvoorbeeld filteren op de ingevulde antwoorden gemakkelijker.
                </p>
                <p>
                  De punten waar naar gekeken wordt is in dit onderzoeken zijn bepaald met de mogelijkheden die al in data panel zaten, met daarbij gewenste mogelijkheden die uit de brainstormsessie zijn gekomen.
                </p>
                ...
                <p>Er is een telefoongesprek geweest met <InlineLink text="Diamond forms" link="https://www.diamondforms.net/nl/" newTab={true} />[2]. Diamond forms is een platform die te gebruiken is tegen een abonnement. Diamond forms kan <Tooltip woord="geïntegreerd" /> worden met bestaande websites. Diamond forms kan echter geen <Tooltip woord="JSON" /> output geven, dus deze mogelijkheid is afgevallen gezien dit de manier is waarop alles in Data panel geregeld wordt.</p>
              </div>
              <div ref={Conclusie}>
                <h2>Conclusie</h2>
                <p>Dit onderzoek heeft toevoeging geleverd voor deelvraag 1b:</p>
              ...
              <div ref={Bronnen}>
                ...
                <p>
                  [2] Diamond Online Formulieren. (z.d.). Diamond Online Forms. Geraadpleegd op 16 maart 2021, van https://www.diamondforms.net/nl/
                </p>
              </div>
